...
describe "minutes/motions/new" do
  before(:each) do
    assign(:minutes_motion, stub_model(Minutes::Motion,
      :order => 1,
      :mover => nil,
      :pro => 1,
      :con => 1,
  ...
  it "renders new minutes_motion form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", minutes_motions_path, "post" do
